...
export class SemaDropdownPage extends LitElement {
	static properties = {
	...
	render() {
		return html`
			<div class="header">
				<span class="badge">Components / Dropdown</span>
				<h1>Sema Dropdown</h1>
				<p class="lead">
					El componente <code>&lt;sema-dropdown&gt;</code> es un elemento de
					interfaz versátil que permite renderizar dropdowns o submenus para el
			...
			<section>
				...
				<sema-code-snippet
					...
					&lt;sema-dropdown label="dropdown" items='[{"label": "Perfil", "path":
					"/perfil"}, {"label": "Salir", "path": "/logout"}]'
					&gt;&lt;/sema-dropdown&gt; ); }</sema-code-snippet
				>
				<p>
				...
				<sema-code-snippet
					>import "@jegdev/semaui"; &lt;sema-dropdown label="dropdown"
					items='[{"label": "Perfil", "path": "/perfil"}, {"label": "Salir",
					"path": "/logout"}]' &gt;&lt;/sema-dropdown&gt;</sema-code-snippet
				>
				...
				<sema-code-snippet
					>&lt;sema-dropdown label="dropdown" items='[{"label": "Perfil",
					"path": "/perfil"}, {"label": "Salir", "path": "/logout"}]'
					&gt;&lt;/sema-dropdown&gt;</sema-code-snippet
				>
			...
			<section>
				...
				<h3>1. Dropdown básico</h3>
				<p>
					Por defecto, el componente renderiza un nombre para el botón
					(label="string") y una lista de items (enlaces) para el usuario
					utilizando un array con formato (items='[{"label": "string", "path":
					"string"}]') y con los estilos del icono de flecha rojo.
				</p>
				...
				<h3>2. Dropdown avanzado</h3>
				<p>
					Cuando se requiere el componente sema-dropdown puede renderizar los
					links divididos por catedorias, para lograrlo solo hay que agregar la
					propiedad nueva ("category": "string") al array que se le proporciona
					a items de la siguiente manera y seguido reagrupar los links en una
					propiedad nueva ("items": [])
				</p>
				...
				<sema-code-snippet
					>&lt;sema-dropdown label="Opciones" color="blue" items='[ {"category":
					"Cuenta", "items": [{"label": "Perfil", "path": "/perfil"}, {"label":
					"Ajustes", "path": "/ajustes"}]}, {"category": "Sesión", "items":
					[{"label": "Cerrar Sesión", "path": "/logout"}]} ]'
					&gt;&lt;/sema-dropdown&gt;</sema-code-snippet
				>

				<h3>3. Cambiar color</h3>
				<p>
					Para que el componente de acordion cambie su color predeterminado
					define la propiedad <code>color=""</code>.
				</p>
				...
				<sema-code-snippet
					>&lt;sema-dropdown color="blue" label="dropdown" items='[{"label":
					"Perfil", "path": "/perfil"}, {"label": "Salir", "path": "/logout"}]'
					&gt;&lt;/sema-dropdown&gt;</sema-code-snippet
				>
				...
				<sema-code-snippet
					>&lt;sema-dropdown color="#0077ff" label="dropdown" items='[{"label":
					"Perfil", "path": "/perfil"}, {"label": "Salir", "path": "/logout"}]'
					&gt;&lt;/sema-dropdown&gt;</sema-code-snippet
				>
				...
				<p>Con rgb()</p>
				<sema-code-snippet
					>&lt;sema-dropdown color="rgb(0, 85, 255)" label="dropdown"
					items='[{"label": "Perfil", "path": "/perfil"}, {"label": "Salir",
					"path": "/logout"}]' &gt;&lt;/sema-dropdown&gt;</sema-code-snippet
				>
			</section>
				...
				<table>
					...
					<tbody>
						...
						<tr>
							...
							<td><code>String</code></td>
							<td><code>""</code></td>
							<td>Puedes pasarle aqui el titulo de la pregunta.</td>
						</tr>
						<tr>
							<td><code>items</code></td>
							<td><code>Array</code></td>
							<td><code>[]</code></td>
							<td>Pueder pasarle aqui el array corres pondiente.</td>
						</tr>
					</tbody>
				</table>
			</section>
...
customElements.define("page-dropdown", SemaDropdownPage);
