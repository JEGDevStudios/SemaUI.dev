...
export class SemaAccordionPage extends LitElement {
	static properties = {
	...
	render() {
		return html`
			<div class="header">
				<span class="badge">Components / Accordion</span>
				<h1>Sema Accordion</h1>
				<p class="lead">
					El componente <code>&lt;sema-accordion&gt;</code> es un elemento de
					interfaz versátil que permite renderizar acordiones para el usuario ya
			...
			<section>
				...
				<sema-code-snippet
					...
					&lt;div&gt; &lt;sema-accordion question="hola"
					answer="adios"&gt;&lt;/sema-accordion&gt; &lt;/div&gt; );
					}</sema-code-snippet
				>
				<p>
				...
				<sema-code-snippet>import "@jegdev/semaui";</sema-code-snippet>
				<sema-code-snippet
					>&lt;sema-accordion question="hola" answer="adios"
					&gt;&lt;/sema-accordion&gt;</sema-code-snippet
				>
			...
			<section>
				...
				<p>
					Por defecto, el componente renderiza una pregunta de tipo string para
					el usuario (question="pregunta") y una respuesta de tipo string para
					el usuario (answer="respuesta") con los estilos del icono de flecha
					rojo.
				</p>
				...
				<sema-code-snippet
					>&lt;sema-accordion question="pregunta" answer="respuesta"
					&gt;&lt;/sema-accordion&gt;</sema-code-snippet
				>
				...
				<sema-code-snippet
					>&lt;sema-accordion color="blue" question="pregunta"
					answer="respuesta" &gt;&lt;/sema-accordion&gt;</sema-code-snippet
				>
				...
				<sema-code-snippet
					>&lt;sema-accordion color="#0077ff" question="pregunta"
					answer="respuesta" &gt;&lt;/sema-accordion&gt;</sema-code-snippet
				>

				<p>Con rgb()</p>
				<sema-code-snippet
					>&lt;sema-accordion color="rgb(0, 85, 255)" question="pregunta"
					answer="respuesta" &gt;&lt;/sema-accordion&gt;</sema-code-snippet
				>
			</section>
				...
				<table>
					...
					<tbody>
						...
						<tr>
							...
							<td><code>String</code></td>
							<td><code>""</code></td>
							<td>Pueder pasarle aqui la respuesta de la pregunta.</td>
						</tr>
					</tbody>
				</table>
			</section>
...
customElements.define("page-accordion", SemaAccordionPage);
